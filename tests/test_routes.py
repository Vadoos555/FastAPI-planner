...
async def access_token() -> str:
    return create_access_token('test_user@i.ua')


@pytest.fixture(scope='module')
async def mock_event() -> Event:
    new_event = Event(
        creator="test_user@i.ua",
        title="FastAPI course",
        image="https://linktomyimage.com/image.png",
        description="We will be discussing the contents of the FastAPI!",
        tags=["python", "fastapi", "course"],
        location="Ukraine center" 
    )
...
async def test_post_event(default_client: httpx.AsyncClient, access_token: str) -> None:
    payload = {
        "title": "FastAPI course",
        "image": "https://linktomyimage.com/image.png",
        "description": "We will be discussing about the FastAPI!",
        "tags": ["python","fastapi","course"],
        "location": "Ukraine center",}
